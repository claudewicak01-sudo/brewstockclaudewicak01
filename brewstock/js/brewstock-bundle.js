...
const Router = {
  ...
  routes: {
    'dashboard':       { label: 'Dashboard',       render: (el) => PageDashboard.render(el),    admin: false },
    'master-bahan':    { label: 'Master Bahan',     render: (el) => PageMasterBahan.render(el), admin: false },
    'master-menu':     { label: 'Master Menu',      render: (el) => PageMasterMenu.render(el),  admin: false },
    'resep':           { label: 'Resep',            render: (el) => PageResep.render(el),       admin: false },
    'approval':        { label: 'Approval Center',  render: (el) => PageApproval.render(el),    admin: true  },
    'pembelian':       { label: 'Pembelian',        render: (el) => PagePembelian.render(el),   admin: false },
    'penjualan':       { label: 'Penjualan',        render: (el) => PagePenjualan.render(el),   admin: false },
    'stock':           { label: 'Stock',            render: (el) => PageStock.render(el),       admin: false },
    'stock-opname':    { label: 'Stock Opname',     render: (el) => PageStockOpname.render(el), admin: false },
    'daily-report':    { label: 'Daily Report',     render: (el) => PageDailyReport.render(el), admin: false },
    'audit-center':    { label: 'Audit Center',     render: (el) => PageAuditCenter.render(el), admin: true  },
    'audit-trail':     { label: 'Audit Trail',      render: (el) => PageAuditTrail.render(el),  admin: true  },
    'user-management': { label: 'User Management',  render: (el) => PageUserMgmt.render(el),    admin: true  },
  },
